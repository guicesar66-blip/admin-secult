...
export const equipamentosMock: EquipamentoCultural[] = [
  ...
  // Espaços vinculados a Produtoras (consistência com mockProdutoras)
  { id: "eq-029", nome: "Pátio de São Pedro", tipo: "Espaço Independente", municipio: "Recife", mesorregiao: "Metropolitana", gestao: "Público", status: "Ativo", conservacao: "Bom", acessibilidade: a1, nivelAcessibilidade: acessivel(a1), linguagens: ["Cultura Popular", "Música", "Dança"], publicoMensal: 3800, projetosRealizados: 20, avaliacaoArtistas: 4.0, avaliacaoCidadaos: 4.3, location: { lat: -8.0636, lng: -34.8769 } },
  { id: "eq-030", nome: "Centro Cultural de Olinda", tipo: "Espaço Independente", municipio: "Olinda", mesorregiao: "Metropolitana", gestao: "Público", status: "Ativo", conservacao: "Bom", acessibilidade: a3, nivelAcessibilidade: acessivel(a3), linguagens: ["Literatura", "Música", "Teatro"], publicoMensal: 1800, projetosRealizados: 9, avaliacaoArtistas: 3.9, avaliacaoCidadaos: 4.0, location: { lat: -8.0125, lng: -34.8490 } },
  { id: "eq-031", nome: "Marco Zero", tipo: "Espaço Independente", municipio: "Recife", mesorregiao: "Metropolitana", gestao: "Público", status: "Ativo", conservacao: "Excelente", acessibilidade: a2, nivelAcessibilidade: acessivel(a2), linguagens: ["Música", "Dança", "Cultura Popular", "Patrimônio"], publicoMensal: 6500, projetosRealizados: 25, avaliacaoArtistas: 4.5, avaliacaoCidadaos: 4.7, location: { lat: -8.0631, lng: -34.8712 } },

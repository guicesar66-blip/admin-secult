...
export const coletivosMock: Coletivo[] = [
  ...
  },
  {
    ...
    membrosLista: [
      {
        id: "m12", nome: "Thiago Ribeiro", foto: "", funcao: "Diretor", status: "ativo",
        representanteLegal: true, cpf: "333.000.000-01", nascimento: "1994-06-14",
        genero: "Homem cis", racaCor: "Parda", municipio: "Petrolina",
        email: "thiago.r@email.com", telefone: "(87) 99300-0001",
        escolaridade: "Médio completo", certificacoes: [],
        faixaRenda: "Até R$ 600", situacaoMoradia: "Alugada",
        servicosBasicos: { agua: true, energia: true, coletaLixo: false, esgoto: false, internet: false },
        vulnerabilidades: ["Insegurança alimentar", "Dependente sem renda"],
        beneficiarioProgramaSocial: "sim", linguagens: ["Audiovisual", "Música"],
        tempoAtuacao: 5, formalizacao: "Informal", scoreReputacao: 50,
        coletivosRelacionados: [{ nome: "Coletivo Canoa", periodo: "2023–atual", status: "ativo", representante: true }],
      },
      {
        id: "m13", nome: "Juliana Mendes", foto: "", funcao: "Câmera", status: "inativo",
        representanteLegal: false, cpf: "333.000.000-02", nascimento: "1999-03-20",
        genero: "Mulher cis", racaCor: "Branca", municipio: "Petrolina",
        email: "juliana.m@email.com", telefone: "(87) 99300-0002",
        escolaridade: "Superior incompleto", certificacoes: [],
        faixaRenda: "Sem renda", situacaoMoradia: "Cedida",
        servicosBasicos: { agua: true, energia: true, coletaLixo: true, esgoto: false, internet: true },
        vulnerabilidades: ["Condição de rua (passada)"],
        beneficiarioProgramaSocial: "nao", linguagens: ["Audiovisual", "Artes Visuais"],
        tempoAtuacao: 2, formalizacao: "Informal", scoreReputacao: 40,
        coletivosRelacionados: [{ nome: "Coletivo Canoa", periodo: "2023–2024", status: "encerrado" }],
      },
      {
        id: "m14", nome: "Pedro Nascimento", foto: "", funcao: "Editor", status: "ativo",
        representanteLegal: false, cpf: "333.000.000-03", nascimento: "1991-10-05",
        genero: "Homem cis", racaCor: "Preta", municipio: "Petrolina",
        email: "pedro.n@email.com", telefone: "(87) 99300-0003",
        escolaridade: "Médio completo", certificacoes: [],
        faixaRenda: "R$ 600–1.320", situacaoMoradia: "Própria",
        servicosBasicos: { agua: false, energia: true, coletaLixo: false, esgoto: false, internet: false },
        vulnerabilidades: ["Dependente sem renda"],
        beneficiarioProgramaSocial: "nao", linguagens: ["Audiovisual"],
        tempoAtuacao: 8, formalizacao: "Informal", scoreReputacao: 48,
        coletivosRelacionados: [{ nome: "Coletivo Canoa", periodo: "2023–atual", status: "ativo" }],
      },
    ],
    projetos: [],
    espacosVinculados: [],
  ...
  },
  {
    ...
    membrosLista: [
      {
        id: "m15", nome: "Roberto Cavalcanti", foto: "", funcao: "Rabequeiro", status: "ativo",
        representanteLegal: true, cpf: "444.000.000-01", nascimento: "1975-08-20",
        genero: "Homem cis", racaCor: "Parda", municipio: "Recife",
        email: "roberto.c@email.com", telefone: "(81) 99400-0001",
        escolaridade: "Superior completo", areaFormacao: "Licenciatura em Música (UFPE)",
        certificacoes: ["Luteria (FUNDARPE 2016)"], faixaRenda: "R$ 1.320–2.640",
        situacaoMoradia: "Própria",
        servicosBasicos: { agua: true, energia: true, coletaLixo: true, esgoto: true, internet: true },
        vulnerabilidades: [], beneficiarioProgramaSocial: "nao",
        linguagens: ["Música", "Cultura Popular"], tempoAtuacao: 25, formalizacao: "MEI", scoreReputacao: 92,
        coletivosRelacionados: [{ nome: "Grupo Rabeca Viva", periodo: "2019–atual", status: "ativo", representante: true }],
      },
      {
        id: "m16", nome: "Sandra Moreira", foto: "", funcao: "Vocalista", status: "ativo",
        representanteLegal: false, cpf: "444.000.000-02", nascimento: "1982-11-14",
        genero: "Mulher cis", racaCor: "Preta", municipio: "Recife",
        email: "sandra.m@email.com", telefone: "(81) 99400-0002",
        escolaridade: "Pós-graduação", areaFormacao: "Etnomusicologia",
        certificacoes: ["Canto Popular (UFPE 2015)"], faixaRenda: "Acima R$ 2.640",
        situacaoMoradia: "Própria",
        servicosBasicos: { agua: true, energia: true, coletaLixo: true, esgoto: true, internet: true },
        vulnerabilidades: [], beneficiarioProgramaSocial: "nao",
        linguagens: ["Música"], tempoAtuacao: 18, formalizacao: "MEI", scoreReputacao: 85,
        coletivosRelacionados: [{ nome: "Grupo Rabeca Viva", periodo: "2019–atual", status: "ativo" }],
      },
      {
        id: "m17", nome: "André Batista", foto: "", funcao: "Percussionista", status: "ativo",
        representanteLegal: false, cpf: "444.000.000-03", nascimento: "1997-03-28",
        genero: "Homem cis", racaCor: "Parda", municipio: "Recife",
        email: "andre.b@email.com", telefone: "(81) 99400-0003",
        escolaridade: "Superior completo", certificacoes: [],
        faixaRenda: "R$ 600–1.320", situacaoMoradia: "Alugada",
        servicosBasicos: { agua: true, energia: true, coletaLixo: true, esgoto: true, internet: true },
        vulnerabilidades: ["Dependente sem renda"], beneficiarioProgramaSocial: "nao",
        linguagens: ["Música", "Percussão"], tempoAtuacao: 8, formalizacao: "Informal", scoreReputacao: 70,
        coletivosRelacionados: [{ nome: "Grupo Rabeca Viva", periodo: "2020–atual", status: "ativo" }],
      },
      {
        id: "m18", nome: "Cláudia Freitas", foto: "", funcao: "Flautista", status: "ativo",
        representanteLegal: false, cpf: "444.000.000-04", nascimento: "1989-07-03",
        genero: "Mulher cis", racaCor: "Branca", municipio: "Recife",
        email: "claudia.f@email.com", telefone: "(81) 99400-0004",
        escolaridade: "Pós-graduação", areaFormacao: "Musicologia",
        certificacoes: ["Flauta Barroca (UNESP 2017)"], faixaRenda: "Acima R$ 2.640",
        situacaoMoradia: "Própria",
        servicosBasicos: { agua: true, energia: true, coletaLixo: true, esgoto: true, internet: true },
        vulnerabilidades: [], beneficiarioProgramaSocial: "nao",
        linguagens: ["Música"], tempoAtuacao: 14, formalizacao: "MEI", scoreReputacao: 80,
        coletivosRelacionados: [{ nome: "Grupo Rabeca Viva", periodo: "2019–atual", status: "ativo" }],
      },
    ],
    projetos: [

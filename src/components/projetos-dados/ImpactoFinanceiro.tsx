...
import { DollarSign, Briefcase, TrendingUp, ShoppingBag } from "lucide-react";
import { projetosMock, receitaPorFonteMensal, getKPIsProjetos } from "@/data/mockProjetos";
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="pt-5 pb-4">
            ...
            <p className="text-2xl font-bold">R$ 4,7 mi</p>
        ...
        <Card>
          ...
          <CardContent>
            <ChartContainer config={{ renda: { label: "Renda (R$)", color: "hsl(var(--primary))" } }} className="h-[250px] w-full">
              <BarChart data={rendaPorLinguagem} layout="vertical" margin={{ top: 5, right: 30, left: 10, bottom: 5 }}>
                <CartesianGrid strokeDasharray="3 3" className="stroke-border/40" />

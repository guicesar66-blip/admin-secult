...
const incubacoes = [{
  ...
  id: 5,
  titulo: "Aceleradora de Bandas Emergentes",
  categoria: "FORMACAO",
  status: "EM_ANDAMENTO",
  statusVariant: "success" as const,
  descricao: "Programa intensivo de 6 meses para bandas em início de carreira com mentoria, gravação e apresentações ao vivo",
  modalidade: "PRESENCIAL",
  cargaHoraria: 200,
  vagas: 12,
  vagasPreenchidas: 12,
  ...
  dataFim: "28/02/2026",
  facilitadores: ["Banda Mestre", "Luciana Gestora", "Ricardo Som"],
  avaliacaoMedia: 4.9,
  taxaConclusao: 78,
  modulos: 12,
  criador: "Instituto de Música Popular"
}, {
  id: 6,
  titulo: "Laboratório de Criação Audiovisual",
  categoria: "WORKSHOP",
  status: "PUBLICADO",
  statusVariant: "info" as const,
  descricao: "Imersão em técnicas de videoclipe, documentário musical e conteúdo para redes sociais",
  modalidade: "HIBRIDO",
  cargaHoraria: 60,
  vagas: 20,
  vagasPreenchidas: 14,
  ...
  dataFim: "10/03/2026",
  facilitadores: ["Diretor Visual", "Editora Pro"],
  avaliacaoMedia: null,
  taxaConclusao: null,
  modulos: 6,
  criador: "Produtora Criativa"
}, {
  id: 7,
  titulo: "Mentoria Financeira para Artistas",
  categoria: "MENTORIA",
  status: "EM_ANDAMENTO",
  statusVariant: "success" as const,
  descricao: "Acompanhamento individual sobre gestão financeira, direitos autorais e monetização",
  modalidade: "ONLINE",
  cargaHoraria: 30,
  vagas: 8,
  vagasPreenchidas: 8,
  ...
  dataFim: "15/01/2026",
  facilitadores: ["Contador Artístico"],
  avaliacaoMedia: 4.7,
  taxaConclusao: 90,
  modulos: 5,
  criador: "Assessoria Cultural"
}, {
  id: 8,
  titulo: "Formação em Técnica Vocal",
  categoria: "FORMACAO",
  status: "CONCLUIDO",
  statusVariant: "info" as const,
  descricao: "Curso completo de técnica vocal com foco em saúde vocal e performance ao vivo",
  modalidade: "PRESENCIAL",
  cargaHoraria: 80,
  vagas: 15,
  vagasPreenchidas: 15,
  ...
  dataFim: "30/09/2025",
  facilitadores: ["Professora Voz", "Fonoaudióloga Musical"],
  avaliacaoMedia: 4.6,
  taxaConclusao: 95,
  modulos: 10,
  criador: "Conservatório Regional"
}, {
  id: 9,
  titulo: "Consultoria em Distribuição Digital",
  categoria: "CONSULTORIA",
  status: "PUBLICADO",
  statusVariant: "info" as const,
  descricao: "Orientação especializada sobre plataformas de streaming, agregadoras e estratégias de lançamento",
  modalidade: "ONLINE",
  cargaHoraria: 15,
  vagas: 25,
  vagasPreenchidas: 18,
  ...
  dataFim: "20/02/2026",
  facilitadores: ["Especialista Digital"],
  avaliacaoMedia: null,
  taxaConclusao: null,
  modulos: 3,
  criador: "Label Indie"
  ...
  id: 10,
  titulo: "Workshop de Iluminação para Shows",
  categoria: "WORKSHOP",
  status: "RASCUNHO",
  statusVariant: "warning" as const,
  descricao: "Técnicas de iluminação cênica e design de luz para apresentações musicais",
  modalidade: "PRESENCIAL",
  cargaHoraria: 24,
  vagas: 18,
  vagasPreenchidas: 0,
  ...
  dataFim: "17/02/2026",
  facilitadores: ["Lighting Designer"],
  avaliacaoMedia: null,
  taxaConclusao: null,
  modulos: 4,
  criador: "Casa de Shows Central"
}];

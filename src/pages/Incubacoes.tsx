        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="explorar" className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              {incubacoes.filter(inc => inc.status !== "RASCUNHO").map((item) => (
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      placeholder="Descreva o programa de capacitação..."
                    />
                  </div>
                ...
                <Card className="border-dashed">
                  <CardContent className="pt-6">
                    <div className="flex flex-col items-center justify-center py-6 text-center">
                      ...
                      <h3 className="text-lg font-semibold mb-2">Crie um programa de capacitação</h3>
                      <p className="text-sm text-muted-foreground mb-4 max-w-md">
                        Ofereça formações, mentorias ou workshops para artistas e profissionais da cultura
                      </p>
                            ...
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <BadgeStatus variant={item.statusVariant}>
                                {item.status === "EM_ANDAMENTO" ? "Em Andamento" : 
                                 item.status === "PUBLICADO" ? "Publicado" :
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
                  <Select>
                    ...
                    <SelectContent>
                      <SelectItem value="all">Todas</SelectItem>
                      {incubacoes.map(inc => (
                        <SelectItem key={inc.id} value={String(inc.id)}>{inc.titulo}</SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
              ...
              <CardContent className="pt-6">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody>
                      {matriculas.map((mat) => (
                        <tr key={mat.id} className="border-b border-border last:border-0 hover:bg-muted/50">
